  ...
  useEffect(() => {
    if (location.state === null) {
      ...
      const singleQuantityPrice = singleQuantity
        ...
        : 0;
      const total1 = location.state.total
                                ...
                                <p>
                                  <input
                                    ...
                                    onKeyDown={(e) => {
                                      if (
                                        checked
                                          ? userData.district.length
                                          : shipAddress.district.length === 0 &&
                                            e.key === " "
                                      ) {
                                        e.preventDefault();
                                        return;
