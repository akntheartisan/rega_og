...
const ProductSection = () => {
    ...
    return (
        <div className="container-fluid" style={{ padding: "20px", border: "5px solid #F28123" }}>
            <div className="section-title">
                <h3 style={{ textAlign: "center" }}>
                    <span className="orange-text">Our</span> Products
                </h3>
                <p style={{ textAlign: "center", fontWeight: "600" }}>
                    Electric scooters offer a sleek, eco-friendly transportation solution, combining modern design with zero emissions. Perfect for urban commuting, they provide a quiet and efficient ride while reducing your carbon footprint.
                </p>
            </div>
